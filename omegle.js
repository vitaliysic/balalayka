...
function middotify(a) {
    for (var b = new Element("span"), c = 0; c < a.length; c++) c > 0 && b.appendText(" вЂўВ "), b.grab(a[c]);
    return b
}
...
function confirmTerms(a, b) {
    ...
    e.style.position = "fixed", e.style.top = 0, e.style.left = 0, e.style.width = "100%", e.style.height = "100%", e.style.overflow = "auto", e.style.zIndex = "10000", e.style.backgroundColor = "#000", e.style.backgroundColor = "rgba(0, 0, 0, 0.4)", e.addEventListener("click", function(a) {
        a.currentTarget === a.target && c()
    });
    var f = document.createElement("div");
    f.style.position = "relative", f.style.backgroundColor = "#FFF", f.style.margin = "15% auto", f.style.padding = "1em", f.style.width = "50%", f.style.boxShadow = "5px 5px 10px 5px rgba(0, 0, 0, 0.333)", IS_MOBILE && (f.style.width = "80%"), f.style.borderRadius = "2em";
    var g = document.createElement("a");
    g.href = "#", g.style.color = "#555", g.style.textDecoration = "none", g.style.fontSize = "2em", g.style.position = "absolute", g.style.top = ".25em", g.style.right = ".5em", g.style.lineHeight = "1", g.appendChild(document.createTextNode("Г—")), g.addEventListener("click", function(a) {
        a.preventDefault(), c()
    }), f.appendChild(g);
    ...
    var i = [],
        ...
        k = !1,
        l = d();
    l.appendChild(document.createTextNode("By checking the box you acknowledge that you have reviewed and agree to be bound by OmegleвЂ™s "));
    ...
    if (1 === a) {
        ...
        q.target = "_blank", q.href = "/static/terms.html", q.appendChild(document.createTextNode("Terms of Service")), p.appendChild(q), p.appendChild(document.createTextNode(" for more info. "));
        var r = document.createElement("strong");
        r.appendChild(document.createTextNode("By checking the box you acknowledge and represent that you comply with these age restrictions.")), p.appendChild(r)
    } else {
        ...
        q.target = "_blank", q.href = "/static/terms.html", q.appendChild(document.createTextNode("Terms of Service")), p.appendChild(q), p.appendChild(document.createTextNode(" for more info. "));
        var r = document.createElement("strong");
        r.appendChild(document.createTextNode("By checking the box you acknowledge and represent that you are 18 years (or the age of legal majority in your jurisdiction) or older.")), p.appendChild(r)
    }
    var s = document.createElement("p");
    s.style.textAlign = "right", s.appendChild(h), s.addEventListener("click", function() {
        if (h.disabled && !k) {
            var a = [];
            k = !0;
    ...
    }), f.appendChild(s), e.appendChild(f), document.body.appendChild(e)
}
...
function startFlashing() {
    ...
    if (!IS_MOBILE && !isFlashing()) {
        var b = [
            ...
            ["ВЇВЇВЇOmegleВЇВЇВЇ", "/static/altfavicon.png"]
        ];
    ...
    confirmTerms(e ? 2 : 1, function() {
        ...
        function I() {
            if (!IS_MOBILE) {
                ...
                if (unmonSexyButton.addEvent("click", function() {
                    ...
                    b += a ? "video" : "text", confirmAdultSite() && window.open("http://wawadmin.omegle.com/redir/" + (IS_MOBILE ? "mob" : "y") + "?track=" + b + unmonSexyTrack)
                }), null === unmonGayButton) {
                ...
                unmonGayButton.addEvent("click", function() {
                    null !== cb && cb();
                    var b = "unmon-upper-" + (shouldForceUnmonitored ? "" : "not") + "forced-";
                    b += a ? "video" : "text", confirmAdultSite() && window.open("http://wawadmin.omegle.com/redir/gay?track=" + b + unmonGayTrack)
                });
                var d = new Element("div");
        ...
        function J(f) {
            ...
            if (!db) {
                ...
                }), U.push(Y), IS_MOBILE || (N.appendText(" Save the log: "), N.grab(middotify(R)), N.appendText(" вЂўВ Or post log to: "), N.grab(middotify(U)));
                var Z = aurrp;
        ...
        function R() {
            ...
            var d = new Element("button", {
                ...
                events: {
                    click: function(a) {
                        a.preventDefault(), cb && cb(), confirmAdultSite() && window.open("http://wawadmin.omegle.com/redir/y?track=" + c)
                    }
                }
            });
            ...
            var f = new Element("div", {
                ...
                g = new Element("button", {
                    "class": "lowergaybtn",
                    text: "В gay camsВ  (free" + (e ? "" : ", 18+") + ")",
                    events: {
                        click: function(a) {
                            a.preventDefault(), cb && cb(), confirmAdultSite() && window.open("http://wawadmin.omegle.com/redir/gay?track=" + c)
                        }
                    }
                });
            return f.grab(g), pb.grab(f), ob.grab(pb, "after"), "undefined" == typeof doUnmonSexyTest && (doUnmonSexyTest = Math.random() < .5), c += "-none-" + (doUnmonSexyTest ? "y" : "n"), Q = function() {
                var a = ["рџ’‹ *soft moan*", "adult cams (free)"];
                a[1] = "girlВ cams В В (free)В В ";
                for (var b = null;
        ...
        if (R() || e || chatPervTrack.push(!1), "undefined" == typeof doAVCtest && (doAVCtest = Math.random() < .5), a) {
            $("videowrapper") || $(document.body).grab(new Element("div", {
                ...
                events: {
                    click: function(a) {
                        a.preventDefault(), cb && cb(), confirmAdultSite() && window.open("http://wawadmin.omegle.com/redir/y?track=avc-108-" + (doAVCtest ? "y" : "n"))
                    }
                },
